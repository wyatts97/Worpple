export class AbstractGrid {
	 ...
	 * @param {Number} index
	 * @returns {import('\$lib/games/pipes/grids/polygonutils').RegularPolygonTile|
	 * import('\$lib/games/pipes/grids/polygonutils').TransformedPolygonTile}
	 */
	polygon_at(index) {
	 ...
	 * @param {import('\$lib/games/pipes/viewbox').ViewBox} box
	 * @returns {import('\$lib/games/pipes/viewbox').VisibleTile[]}
	 */
	getVisibleTiles(box) {
	 ...
	 * @param {import('\$lib/games/pipes/controls').PointerOrigin} point
	 */
	whichEdge(point) {
