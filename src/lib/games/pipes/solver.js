...
import { OctaGrid } from '\$lib/games/pipes/grids/octagrid';
...
/**
 * @constructor
 * @param {import('\$lib/games/pipes/grids/polygonutils').RegularPolygonTile} polygon
...
export function Solver(tiles, grid) {
	...
	self.doLocalDeductions = function (index, cell) {
		...
		/** @type {(import('\$lib/games/pipes/grids/polygonutils').TileType|null)[]} */
